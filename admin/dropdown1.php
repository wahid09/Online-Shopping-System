...
<body>
<div id="header"><p class="outset">Enter your Manufacturer Name</p></div>
<form action='manu_add.php' method='post'>
	<table>
		<tr>
			<td></p>Manufacturer Name:</p></td>
			<td><p><input type='text' name='manu_name'></p></td>
		</tr>
		<tr>
			<td>
			</td>
			<td><p><input type='submit' value='add'></p></td>
		</tr>
	</table>	
</form>